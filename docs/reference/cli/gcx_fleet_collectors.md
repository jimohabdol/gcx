...
* [gcx fleet collectors list](gcx_fleet_collectors_list.md)	 - List collectors.
* [gcx fleet collectors update](gcx_fleet_collectors_update.md)	 - Update a collector from a file.
