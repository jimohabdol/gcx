## gcx synthetic-monitoring checks
...
* [gcx synthetic-monitoring checks create](gcx_synthetic-monitoring_checks_create.md)	 - Create a Synthetic Monitoring check from a file.
* [gcx synthetic-monitoring checks delete](gcx_synthetic-monitoring_checks_delete.md)	 - Delete Synthetic Monitoring checks.
