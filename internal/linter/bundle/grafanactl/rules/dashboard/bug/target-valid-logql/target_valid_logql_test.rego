...
test_dashboard_v1_with_invalid_panel if {
	...
	assert_reports_match(report, {{
		...
		"related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/grafanactl/blob/main/docs/reference/linter-rules/dashboard/target-valid-logql.md"}],
