...
test_dashboard_v1_with_editable_is_rejected if {
	...
	assert_reports_match(r, {{
	    ...
	    "related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/grafanactl/blob/main/docs/reference/linter-rules/dashboard/uneditable-dashboard.md"}],
