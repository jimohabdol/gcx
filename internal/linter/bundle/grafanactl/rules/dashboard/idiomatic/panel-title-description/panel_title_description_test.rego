...
test_dashboard_v1_with_no_title_description if {
	...
	assert_reports_match(report, {{
		...
		"related_resources": [{"description": "documentation", "ref": "https://github.com/grafana/grafanactl/blob/main/docs/reference/linter-rules/dashboard/panel-title-description.md"}],
